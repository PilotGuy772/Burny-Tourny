...
class Program
{
        ...
        try
        {
            ...
            switch(Console.ReadLine())
            {
                ...
                case "4":
                    ...
                    {
                        Console.WriteLine($"{f}:    NAME: {teamsArr[f].Name}; LEADER: {teamsArr[f].Leader}; EVENT: {teamsArr[f].Event}; SCORE: {teamsArr[f].Score}");
                    }
                    break;
                case "5":
                    Environment.Exit(0);
    ...
    public static void ColorPrint(string content, ConsoleColor foreColor)
    {
